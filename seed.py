...
COMMUNITY_POSTS = [
    ...
    ("직장", "수습기간 해고도 부당해고가 될 수 있나요?", False),
    ("직장", "연차 강제 사용 지시, 다들 어떻게 대응하세요?", False),
    ("가족", "협의이혼 절차 직접 진행해 본 후기", False),
    ("가족", "상속 문제로 형제와 갈등, 조언 부탁드립니다", False),
    ("교통", "가벼운 접촉사고 합의 요령 알려주세요", False),
    ("교통", "음주단속 기준이 궁금합니다", False),
    ("부동산", "월세 보증금 반환 내용증명 보낸 후기", False),
    ("부동산", "관리비 폭탄, 임대인에게 항의해도 되나요?", False),
    ("잡담", "변호사 상담 처음 받아봤는데 생각보다 편했어요", False),
    ("잡담", "법률 드라마에서 본 장면, 실제로 가능한가요?", False),
    ("생활법률", "층간소음 항의, 어디까지 허용될까요?", False),
    ("생활법률", "무료 법률 상담 받을 수 있는 곳 정리", False),
]
